...
#define LOG_TAG "stackblur_native"
...
static unsigned short const blur_mul[255] = {
...
static unsigned char const blur_shr[255] = {
...
void blurJob(unsigned char* src,              
             unsigned int w,                   
             unsigned int h,                   
             unsigned int radius,           
             int cores,                       
    ...
    unsigned int mul_sum = blur_mul[radius];
    unsigned char shr_sum = blur_shr[radius];
